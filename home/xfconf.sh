...
xfconf-query -c xfce4-keyboard-shortcuts -p "/commands/custom/<Primary><Shift><Alt>Escape" --create --type string --set "rofi -show combi"
xfconf-query -c xfce4-keyboard-shortcuts -p "/commands/custom/<Alt>F1" --create --type string --set "xfce4-popup-whiskermenu"
